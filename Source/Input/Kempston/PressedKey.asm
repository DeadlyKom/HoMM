...
; -----------------------------------------
; получить Виртуальную Клавишу нажатой клавиши кемпстон джойстика
; In:
; Out:
;   если была нажата клавиша флаг переполнения установлен,
;   регистре E хранится Виртуальная Клавиша, в противном случае флаг cброшен
; Corrupt:
;   DE, AF
; Note:
; -----------------------------------------
