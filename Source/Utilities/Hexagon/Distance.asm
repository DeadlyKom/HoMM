...
; Out:
;   A  - расстояние между гексагонами (в гексагонах)
; Corrupt:
;   HL, DE, BC, AF
; Note:
;   q=X−⌊Y/2⌋, r=Y
; -----------------------------------------
Distance:       ; преобразование первого гексагона в аксиальные координаты
                ; q = x - (y >> 1)
                LD L, D
                LD A, E
                SRA D
                ...
                ; преобразование первого гексагона в аксиальные координаты
                LD L, B
                LD A, C
                SRA B
                SUB B
