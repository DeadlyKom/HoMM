...
RemoveAtSwap:   ; инициализация
                ...
                DEC (HL)
                LD B, (HL)                                                      ; чтение количества элементов в массиве событий
                ...
                ; --------------------------------------------------------------
                ; ⚠️ ВАЖНО ⚠️
                ;   размер события EVENT_SIZE, равен 16, чтобы получить индекс,
                ;   нужно сместить на 4 бита
                ; --------------------------------------------------------------
                ...
                ; адрес расположения элемента = адрес первого элемента + N элемента * EVENT_SIZE
                ...
                display " - Remove at swap 'event':\t\t\t\t", /A, RemoveAtSwap, "\t= busy [ ", /D, $-RemoveAtSwap, " byte(s)  ]"
