...
Spawn:          ; -----------------------------------------
                ...
                EX AF, AF'
                LD C, A
                EX AF, AF'                                                      ; сохраним ID объекта
                PUSH BC                                                         ; сохранение тип объекта и ID объекта

                ; -----------------------------------------
                ; очистка runtime-состояния объекта
                ; -----------------------------------------
                PUSH DE                                                         ; сохранение положения объекта в знакоместах
                ifdef _OPTIMIZE
                LD (HL), #00
                LD D, H
                LD E, L
                ...
                POP DE                                                          ; восстановление положения объекта в знакоместах

                EX AF, AF'                                                      ; восстановим ID объекта
                LD C, A
                ; -----------------------------------------
                ; установка положения объекта
                ; -----------------------------------------
                LD H, E
                LD L, HEXTILE_SIZE_X << 4   ; середина гексагона
                LD (IY + FObject.Position.X), HL

                LD H, D
                LD L, HEXTILE_SIZE_Y << 4   ; середина гексагона
