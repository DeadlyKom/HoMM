...
.Table          ; первый байт, количество пропускаемых колонок первого гексагона (1-6), последующие вычисляются быстро
                ...
                ;
                ; |<-0->|      |<-1->|      |<-2->|      |<-3->|      |<-4->|      |<-5->|
                DB #28+3, 0,    #28+4, 0,    #28+5, 0,    #28+0, 1,    #28+1, 1,    #28+2, 1          ; 0 смещение по вертикали в знакоместах
                DB #28+0, 0,    #28+1, 0,    #28+2, 0,    #28+3, 0,    #28+4, 0,    #28+5, 0          ; 1 смещение по вертикали в знакоместах
