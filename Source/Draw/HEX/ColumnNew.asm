...
.MaskSkipLoop   ; -----------------------------------------
                ...
                JR Z, Column.New.InViewMask                                               ; переход, если последующее отображение колонки в видимой области
                DEC A
                EX AF, AF'
...
.x2             _2_PIXELS_LINES_N                                                ; отображение двух пиксельных строк знакоместа (завершающий)
