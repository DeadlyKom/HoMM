                ...
                ifndef _PLAYER_MUSIC_AY_PT_3_
                define _PLAYER_MUSIC_AY_PT_3_
...
;      7    6    5    4    3    2    1    0
;   +----+----+----+----+----+----+----+----+
;   | FS | SC | G1 | F1 | F0 | С1 | С0 | LP |
;   +----+----+----+----+----+----+----+----+
;
;   FS      [7]     - флаг устанавливается при одинарном проходе TS модуля
;   SC      [6]     - флаг устанавливается при двойном проходе TS модуля
;   F1,F0   [4,3]   - формат
;                       00 - не TS
;                       01 - 2 модуля TS
;                       10 - автодетект PT3
...
;                       01 - ACB
;                       10 - BAC
;   LP      [0]     - флаг зацикленного проигрывания
; -----------------------------------------
Setup	        DB #00
CrPsPtr	        DW #00

                ; идентификатор
	            BYTE "=VTII PT3 Player r."
                DB Release, "="
CHECKLP	        LD HL, Setup
                SET 7, (HL)
                BIT 0, (HL)
...
T_PACK	        DB #06EC*2/256, (#06EC*2) & 0xFF
                DB #0755-#06EC
                DB #07C5-#0755
                DB #083B-#07C5
                DB #08B8-#083B
