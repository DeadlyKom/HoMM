...
.LightmapCell   PUSH BC                                                         ; сохранение счётчиков строк и знакомест
                ...
                XOR A                                                           ; уровень 0 сохраняет исходный атрибут в центре
                LD DE, 7 * 7
                OR A
                SBC HL, DE
                JR C, .LightLevelReady                                           ; уровень 0, если квадрат расстояния меньше 7^2
                ...
                OR A
                SBC HL, DE
                JR C, .LightLevelReady                                           ; уровень 1, если квадрат расстояния меньше 14^2
                ...
                OR A
                SBC HL, DE
                JR C, .LightLevelReady                                           ; уровень 2, если квадрат расстояния меньше 21^2

                LD A, #03                                                       ; уровень 3 за пределами круга освещения
