...
.Debug_FPS      ; ************** Draw FPS **************
                ...
                ; ToDo отключено восстановление 2х байт, экрана, т.к. во время восстановления
                ;      может в RestoreRegister вместо адреса текущей функции портятся данные
                ;      и что-то ещё портится, т.к. бывают микрофризы с поломкой смещения вывода
                ;      гексагонов
...
;                 JP Bootloader.KernelMinimal.Interrupt.Handler.SaveRegs
                ...
                display " - Main 'World' interrupt:\t\t\t\t", /A, Interrupt, "\t= busy [ ", /D, $-Interrupt, " byte(s)  ]"
