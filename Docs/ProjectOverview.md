...
Документация проекта разделена на две самостоятельные части:

- [Игровой дизайн](Game/00_Index.md) — правила игры, решения игрока и взаимодействие систем мира;
- [Архитектурная книга](Architecture/00_Index.md) — устройство движка, данные, runtime-модули и технические контракты.

## Игровой дизайн

- [Глобальное время и длительные действия](Game/01_Global_Time_and_Actions.md) — мировые тики, временная стоимость решений, параллельные процессы и индивидуальная эффективность движения.
- [Перемещение и стоимость маршрута](Game/02_Movement_and_Terrain.md) — формулы движения, стоимость поверхности и независимая настройка скорости проигрывания.
