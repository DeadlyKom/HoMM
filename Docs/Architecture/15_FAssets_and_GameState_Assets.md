...
Она восстанавливается из упаковочного metadata-слоя.
...
### Шаг 1. Builder создаёт metadata
...
При старте runtime asset manager читает metadata и заполняет `Adr.AssetsTable`.
